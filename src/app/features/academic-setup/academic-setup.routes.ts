...
export default [
  {
    path: 'years',
    loadComponent: () => import('@features/academic-setup/year-academic/pages/year-academic/year-academic'),
    title: 'Años Académicos',
    data: { permissions: ['view_academic_year', 'manage_academic_year'] },
  },
  {
    path: 'years/:id',
    loadComponent: () => import('@features/academic-setup/year-academic/pages/year-academic-detail/year-academic-detail'),
  ...
  {
    path: 'subject-areas',
    loadComponent: () => import('@features/academic-setup/subject-areas/pages/subject-areas/subject-areas'),
    title: 'Áreas Curriculares',
    data: { permissions: ['view_subject_area', 'manage_subject_area'] },
  },
  {
    path: 'courses',
    loadComponent: () => import('@features/academic-setup/courses/pages/courses/courses'),
    title: 'Cursos',
    data: { permissions: ['view_course', 'manage_course'] },
  },
  {
    path: 'competencies',
    loadComponent: () => import('@features/academic-setup/competencies/pages/competencies/competencies'),
    title: 'Competencias',
