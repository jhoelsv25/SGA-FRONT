...
@Component({
  ...
  template: `
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 bg-base-100 rounded-3xl border border-base-200 shadow-sm animate-in fade-in slide-in-from-top-4 duration-500">
      <div class="flex items-center gap-4">
        @if (icon()) {
          <div class="w-12 h-12 flex items-center justify-center rounded-2xl bg-primary/10 text-primary">
